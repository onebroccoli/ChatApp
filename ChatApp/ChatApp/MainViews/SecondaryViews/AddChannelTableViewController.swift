...
class AddChannelTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.tableFooterView = UIView() //hide the extra cells
   ...
   //MARK - IBActions
    ...
    @IBAction func saveButtonPressed(_ sender: Any) {
        if nameTextField.text != "" {
            //save new channel, if edit existing channel then editchanel save no need to create new one
    ...
    private func configureEditingView() {
        self.nameTextField.text = channelToEdit!.name //change name
        self.channelId = channelToEdit!.id //keep same id
        self.aboutTextView.text = channelToEdit!.aboutChannel //change about
